...
/// A sequential shortcut composed of multiple steps.
///
/// Each step is a `Shortcut` of any kind. Keyboard keys, mouse buttons, scroll directions,
/// and trackpad gestures are all supported.
